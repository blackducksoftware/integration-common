...
public class JsonFieldResolverTest {
    ...
    public void testResolvingAStringValue() throws IOException {
        ...
        final HierarchicalField<String> jsonField = JsonFieldFactory.createStringJsonField(vulnerabilityIdsFieldPath);
    ...
    public void testChangingFoundValues() throws IOException {
        ...
        final HierarchicalField<String> jsonField = JsonFieldFactory.createStringJsonField(nameFieldPath);
